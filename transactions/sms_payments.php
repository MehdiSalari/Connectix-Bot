                ...
                .then(mainData => {
                    ...
                    html += `<div class="bg-gradient-to-br from-purple-50 to-pink-100 rounded-xl p-6">
                        ...
                        <div class="space-y-3 text-lg">
                            ...
                            ${mainData.user_telegram ? `<div><strong>یوزرنیم:</strong> <a href="https://ble.ir/${mainData.user_telegram}" target="_blank" class="text-blue-600 hover:underline">@${mainData.user_telegram}</a></div>` : ''}
