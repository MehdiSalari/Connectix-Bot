                ...
                <div class="text-center md:text-right">
                    ...
                    <div class="mt-3 space-y-2 text-gray-600">
                        ...
                        <?php if ($user['telegram_id']): ?>
                            <p>یوزرنیم: <a href="https://ble.ir/<?= htmlspecialchars($user['telegram_id']) ?>" target="_blank" class="text-blue-600 hover:underline">@<?= htmlspecialchars($user['telegram_id']) ?></a></p>
                        <?php endif; ?>
